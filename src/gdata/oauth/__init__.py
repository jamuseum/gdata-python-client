...
class OAuthToken(object):
    ...
    def to_string(self):
        return six.moves.urllib.parse.urlencode({'oauth_token': self.key, 'oauth_token_secret': self.secret})
...
class OAuthRequest(object):
    ...
    def to_postdata(self):
        return '&'.join(['%s=%s' % (escape(str(k)), escape(str(v))) for k, v in six.iteritems(self.parameters)])
